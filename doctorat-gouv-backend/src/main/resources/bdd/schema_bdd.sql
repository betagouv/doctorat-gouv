...
-- Table ecole_doctorale pour les écoles doctorales synchronisées depuis Fresq
CREATE TABLE ecole_doctorale (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    numero VARCHAR(3) NOT NULL UNIQUE,
    libelle VARCHAR(250) NOT NULL,
    etablissement_ror VARCHAR(20),
    etablissement_libelle VARCHAR(250),
    uai VARCHAR(20),
    academie VARCHAR(50),
    region_academie VARCHAR(50),
    secteur VARCHAR(50),
    specialite VARCHAR(50),
    active BOOLEAN DEFAULT TRUE,
    date_synchronisation TIMESTAMP,
    fresq_record_id VARCHAR(50)
);
